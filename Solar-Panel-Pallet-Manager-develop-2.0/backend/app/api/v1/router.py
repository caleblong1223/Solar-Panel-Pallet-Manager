...
from app.api.v1.endpoints import auth, barcodes, customers, exports, exports_debug, health, pallets, simulator
...
api_router.include_router(exports_debug.router, prefix="/exports/debug", tags=["exports-debug"])
