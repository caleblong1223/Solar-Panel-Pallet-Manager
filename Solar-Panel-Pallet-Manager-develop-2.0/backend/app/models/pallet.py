...
class SimPanel(Base):
    ...
    pm: Mapped[float | None] = mapped_column(Float, nullable=True)
    isc: Mapped[float | None] = mapped_column(Float, nullable=True)
    voc: Mapped[float | None] = mapped_column(Float, nullable=True)
    ipm: Mapped[float | None] = mapped_column(Float, nullable=True)
    vpm: Mapped[float | None] = mapped_column(Float, nullable=True)
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True),
        nullable=False,
        default=_utc_now,
